...
public class Twitter_Test_AppActivity extends Activity {
	...
	private static final String TWITTER_USER = "remaster.otakufan@gmail.com";
	...
	public void tweet(View view) {
		if (twitter == null) {
			Toast.makeText(this, "Autenticarse Primero", Toast.LENGTH_LONG)
					.show();
			return;
		}
	...
	class PostStatusTask extends AsyncTask<String, Void, String> {
		...
		protected String doInBackground(String... params) {
			try {
				...
				return "Posteado Satisfactoriamente: " + params[0];
